...
const DeliveryNotePrint = forwardRef((props, ref) => {
  ...
  // Function to calculate responsive font size based on text length
  const getResponsiveFontSize = (text, baseSize = 11, minSize = 8, maxLength = 50) => {
    if (!text) return baseSize;
    const length = text.length;
    if (length <= 10) return baseSize;
    if (length <= 20) return Math.max(minSize + 1, baseSize - 1);
    if (length <= 30) return Math.max(minSize, baseSize - 2);
    return minSize;
  };
          ...
          <div class="delivery-note-print">
            <div class="content-wrapper">
              ...
              <div class="tank-number-section">
                <div class="tank-row">
                  <div class="tank-label">លេខឃ្លុំបេផ្នែកខាងលើ:</div>
                  <div class="tank-line">
                    ${renderTankNumbers(data?.top_tank_number)}
                  </div>
                </div>
                <div class="tank-row">
                  <div class="tank-label">លេខឃ្លុំបេផ្នែកខាងក្រោម:</div>
                  <div class="tank-line">
              ...
              <div class="signatures">
               ...
               <p style="font-weight: bold;">ប្រធានស្តុក</p>



                  <div class="signature-line"></div>  
                 <p style="margin-left: -60px;">ឈ្មោះ</p> 
                  <p>ថ្ងៃទី${todayDate}</p>
                </div>
                <div class="signature-block">
                 <p style="font-weight: bold;">គណនេយ្យ</p>
                  <div class="signature-line"></div>
                 <p style="margin-left: -60px;">ឈ្មោះ</p> 
                  <p>ថ្ងៃទី${todayDate}</p>
                </div>
                ...
                <div class="signature-block">
                 <p style="font-weight: bold;">អតិថិជន</p>
                  <div class="signature-line"></div>
                  <p>ឈ្មោះ</p>
                  <p>ថ្ងៃទី</p>
                </div>
            ...
            <div class="document-footer">
              <div class="footer-left">
                <div class="footer-item">
                  <span class="footer-label">លេខទូរស័ព្ទអ្នកបើកបរ៖</span>
                  <span class="footer-value">${formatPhoneNumber(data?.driver_phone) || ''}</span>
                </div>
                <div class="footer-item">
                  <span class="footer-label">ផ្លាកលេខ៖</span>
                  <span class="footer-value">${data?.vehicle_number || ''}</span>
                </div>
              </div>
              <div class="footer-right">
                <div class="footer-signature">
                  <p class="footer-label">អ្នកបើកបរ</p>
                  <div class="signature-line"></div>
                  <p>ឈ្មោះ <span class="value">${data?.driver_name || ''}</span></p>
                  <p>ថ្ងៃទី</p>
                </div>
              </div>
            </div>
