            ...
            <div class="content-wrapper">
              ...
              <div class="info-container">
                ...
                <div class="info-right">
                  <div class="customer-info-grid">
                    ...
                    <p class="separator">:</p>
                    <p class="metal_address_customer wrap-text ">${data?.customer_address || ''}</p>
              ...
              <div class="signatures">
                <div class="signature-block">
                  <p class="siemreap-bold">ប្រធានស្តុក</p>
                  <div class="signature-line"></div>
                  <p>ឈ្មោះ</p>
                  <p>ថ្ងៃទី</p>
                </div>
                <div class="signature-block">
                  <p class="siemreap-bold">គណនេយ្យ</p>
                  <div class="signature-line"></div>
                  <p>ឈ្មោះ</p>
                  <p>ថ្ងៃទី</p>
                </div>
                ...
                <div class="signature-block">
                  <p class="siemreap-bold">អតិថិជន</p>
                  <div class="signature-line"></div>
                  <p>ឈ្មោះ</p>
                  <p>ថ្ងៃទី</p>
                </div>
