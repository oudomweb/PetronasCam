...
const DeliveryNotePrint = forwardRef((props, ref) => {
  ...
  const printContent = (printData) => {
    ...
    // Create table rows with blank rows if needed
    let tableRows = '';
    ...
    processedItems.forEach((item, idx) => {
      tableRows += `
        <tr>
          ...
          <td class="wrap-text">${item?.khmer_word || ''}</td>
          <td class="wrap-text">${item?.note || ''}</td>
        </tr>
      `;
    });
    
    // Add blank rows if we have less than 3 items
    const blankRowsNeeded = Math.max(0, 3 - processedItems.length);
    ...
    const html = `
        ...
        <head>
          ...
          <style>
            ...
            /* Fixed Grid Layout for Customer Info */
            .customer-info-grid {
              display: grid;
            ...
            /* Style for long addresses that need wrapping */
            .wrap-text {
            ...
            td { 
              ...
              padding: 2mm;
              text-align: center;
              height: 10mm; /* Set minimum height for rows */
            }
            ...
            .signature-block { width: 25%; text-align: center; margin-top: 60px; }
            .signature-line { 
            ...
            /* Table improvements for text wrapping */
            table td {
              word-break: break-word;
              max-width: 150px; /* Limit width to force wrapping */
            }

            /* Empty row style for blank spaces */
            tr.empty-row td {
              height: 30px;
            }
          </style>
            ...
            <div>
              <div class="header-container">
                ...
                <div class="header-section">
                  ...
                  <p class="header-number">លេខ៖ ${data?.delivery_number || ''}</p>
                </div>
              </div>
              ...
              <div class="info-container">
                <div class="info-left">
                  ...
                  <p><span class="siemreap-bold">អាសយដ្ឋាន៖</span><span class="metal_address wrap-text"> ${profile?.address || ''