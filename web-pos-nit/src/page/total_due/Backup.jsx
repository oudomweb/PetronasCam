...
function TotalDuePage() {
  ...
  const handlePaymentSubmit = async () => {
    ...
    try {
      ...
      message.success({
        content: `បានបង់ប្រាក់ ${formatCurrency(paymentAmount)} សម្រាប់វិក័យប័ត្រ ${currentInvoice.order_no}`,
        duration: 5
      });
          ...
          <>
            ...
            <Table
              ...
              columns={[
                ...
                {
                  title: <span className="khmer-text">លេខវិក័យប័ត្រ</span>,
                  dataIndex: "order_no",
      ...
      <Modal
        title={
          <div className="modal-title">
            ...
            <span className="khmer-font">បង់ប្រាក់សម្រាប់វិក័យប័ត្រ: {currentInvoice?.order_no}</span>
          </div>
        }
          ...
          <div className="payment-form">
            <div className="invoice-details">
              <Descriptions bordered column={1} size="small" className="invoice-descriptions">
                ...
                >
                  <span className="description-value english-text">{currentInvoice.order_no}</span>
                </Descriptions.Item>
                <Descriptions.Item
      ...
      <Modal
        title={
          <div className="modal-title">
            ...
            <span className="khmer-font">កែប្រែវិក័យប័ត្រ: {editInvoiceData?.order_no}</span>
          </div>
        }
        ...
        const exportToExcel = async (customer) => {
          try {
            ...
            allOrders.forEach(order => {
              ...
              const invoiceNumber = order.INV_NUMBER || order.order_no || order.invoice_number || `-${rowNumber}`;
